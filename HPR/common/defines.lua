...
NDiplomacy = {
	...
	DEMESNE_MAX_SIZE_DUKE_MULT = 1.5,			-- Extra Max Demesne Size from the ruler's rank
	...
	DEMESNE_MAX_SIZE_GREAT_DUKE_BONUS = 1.5,	-- Extra Max Demesne Size for Dukes with more than one Duchy
	DEMESNE_MAX_SIZE_STEWARDSHIP_MULT = 0.1,	-- Extra Max Demesne Size from ruler and spouse stewardship
	...
	VASSAL_LIMIT_DECADENCE_MULTIPLIER = 0.5,	-- Negative modifier, multiplied with the current decadence.
...
NCharacter = {
	...
	NATURAL_DEATH_CHANCE_AGE_30 = 50,				-- Natural deaths per decade out of 10000 people: Age 30-39
	NATURAL_DEATH_CHANCE_AGE_40 = 100,				-- Natural deaths per decade out of 10000 people: Age 40-49
	NATURAL_DEATH_CHANCE_AGE_50 = 300,				-- Natural deaths per decade out of 10000 people: Age 50-59
	NATURAL_DEATH_CHANCE_AGE_60 = 900,				-- Natural deaths per decade out of 10000 people: Age 60-69
	NATURAL_DEATH_CHANCE_AGE_70 = 2300,				-- Natural deaths per decade out of 10000 people: Age 70-79
	NATURAL_DEATH_CHANCE_AGE_80 = 4700,				-- Natural deaths per decade out of 10000 people: Age 80-90
	...
	INFANT_DEATH_CHANCE = 0.2,						-- Chance of stillbirth / death at birth
	...
	MALE_ATTRACTION_CUTOFF = 45,					-- After this age, the sex appeal of traits no longer have any effect
	FEMALE_ATTRACTION_CUTOFF = 35					-- After this age, the sex appeal of traits no longer have any effect
},
...
NReligion = {
	...
	DIVINE_BLOOD_FERTILITY_MULT = 0.5,				-- Fertility multiplier in a religious close kin marriage
...
NNomad = {
	...
	CLAN_PRESTIGE_SCALE = 0.01,					-- How fast the scale of the prestige opinion bonus/malus grows
	...
	HORDE_REINFORCE_MULTIPLIER = 2,					-- Increased pseed of reinforcing hordes
	...
	CAPITAL_AT_OTHER_HOLY_SITE_PRESTIGE = 0.5,		-- Monthly Prestige for having the capital in the holy site of other religions
...
NMilitary = {
	...
	MERCENARY_HIRE_DISTANCE_THRESHOLD = 650,		-- Mercs will not be available if the province of origin is more distant from your capital
	...
	OPINION_WHEN_NO_LEADER = -20,					-- Below this opinion a vassal will not supply a leader for subunits at all
	...
	VASSAL_SETTLEMENT_WARSCORE_MULTIPLIER = 0.15,	-- Warscore worth for occupied vassals
	...
	VASSAL_PROVINCE_WITHOUT_SETTLEMENT_WARSCORE_MULTIPLIER = 0.01,	-- Warscore worth for occupied vassals in provinces without holdings
	...
	DIFFERENT_RELIGIONGROUP_SUPPLY_PENALTY = -0.25,	-- Only 50% supply in provinces with different religions group
	...
	DAYS_PER_FORTLEVEL_BEFORE_ASSAULT = 15,			-- Number of days until attacker can assault
	...
	LOW_DECADENCE_MORALE_MOD = 0.2,					-- Morale Defence Mod when at 0% decadence
	...
	MAX_COMMANDERS_DUKE = 3,
	MAX_COMMANDERS_KING = 6,
	MAX_COMMANDERS_EMPEROR = 9,
	...
	HEAVY_INFANTRY_MAINTENANCE = 2.5,
...
NTechnology = {
	...
	BASE_NEIGHBOUR_SPREAD_BONUS = 0.05, 		-- bonus for each neighbour with the tech
	...
	IDEAL_YEAR_AHEAD_PENALTY_INVEST = 0.5,		-- Percent increase in cost pre level ahead of ideal date
...
NAI =
{
	...
	INTERACTION_THRESHOLD_FOR_YES = 50,						-- Interactions with chance above this will always be accepted
	...
	MIL_AI_COUNTER_INVADE_DISTANCE_THRESHOLD = 240,			-- Defenders in wars will not counter invade past this distance
	CRUSADE_CREATION_MONTH_DELAY = 120,						-- Months from the end of one Crusade before the AI will call a new one
	...
	MARRIAGE_AI_PRESTIGE_VALUE = 50,						-- Multiplier for how highly AI values prestige when arranging marriages and evaluating marriage offers
	...
	MINIMUM_IMPRISONED_YEARS = 1,							-- AI will keep a newly imprisoned character locked up at least this long before releasing them (reduced for important characters)
	...
	NOMAD_DESIRED_CONSORTS = 1,								-- Nomad bonus to number of desired consorts
